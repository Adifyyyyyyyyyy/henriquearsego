 ...
 */
const cases = [
  { image: "/placeholder.svg", niche: "E-commerce" },
  { image: "/placeholder.svg", niche: "Imobiliário & Incorporação" },
          ...
          {cases.map((c, i) => (
            ...
            >
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-2.5 hover:border-accent/30 transition-colors duration-300">
                <div className="rounded-xl overflow-hidden ring-1 ring-white/5 bg-black/40 aspect-[4/3]">
                  <img
                    src={c.image}
                    alt={`Case — ${c.niche}`}
